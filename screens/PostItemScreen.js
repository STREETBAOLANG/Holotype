...
function PostItemScreen({ navigation }) {
  ...
  const addPost = postsCtx.addPost;
  ...
  if (isSubmiting) {
    return <LoadingOverlay text={"Create your post ..."} />;
  }
        ...
        <KeyboardAvoidingView>
          <ScrollView>
            <View style={styles.createPostContainer}>
              ...
              <ImagePicker addImageHandler={addImageHandler} />
              <HrLine></HrLine>
              <TitleText>Add location</TitleText>
              <LocationPicker addLocationHandler={addLocationHandler} />
              <HrLine></HrLine>
